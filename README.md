...
4.  **Place Regions:**
    ...
    *   Click on the black screen area. A new "region" using that template's dimensions will be placed at the clicked position.
5.  **Edit Graphics:**
...
7.  **Export Code:**
    ...
    *   **All Canvases:** Click the "Export .h (all regions/canvases)" button at the top to download a single `.c` file containing all your graphical assets.
8.  **Save & Load:**
